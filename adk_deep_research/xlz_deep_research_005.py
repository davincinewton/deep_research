...
MODEL_ID_1  = "mimo"#"qwen200b" #"phi-4-reasoning-plus"  #"30a" # "phi4p" #"qwen/qwen3-32b" #"qwen3-14b" #"mistral-small-3.1-24b-instruct-2503" # "27b"# "14b"  # "qwen3-32b" #"gemma-3-27b-it@q8_0" #"qwen3-30b-a3b" #"gemma-3-27b-it-qat" "a72b4b" 
client_1 = OpenAI(
    api_key='lm-studio',
...
def deep_research(test1:str, with_critic=False, second_batch = False, num_source=4, num_reranker=3)->str:
...
# """
    ...
    question_no = 28 # 94 #90 #  93 #92 #104 #
    ...
    if len(filename) < 1:
        ...
        fileresult = md_converter.convert(filename, mlm_prompt= test1) #"describe the image in detail and output using markdown format")
        attachment = fileresult.text_content
        # attachment = ""
        attachment += "\n\ndetailed description is: \n\n" + md_converter.convert(filename, mlm_prompt="describe the image in detail and output using markdown format").text_content
        print("Attachment: ", attachment)
        # has_meaning = run_meaning_check(attachment, modelid=MODEL_ID,clientapi=client)
        # print(has_meaning)
        # try:
        #     has_meaning = json.loads(has_meaning)
        #     has_meaning = has_meaning.get('hasmeaning','no')
        #     if has_meaning.lower() != 'yes':
        #         print('Document does has meaning...')
        #         os._exit(0)
        # except:
