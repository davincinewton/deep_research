    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            while True:
                ...
                screenshot = None
                response = None
                if len(major_images)>0:
                    img = major_images[cnt_scroll]
                    img.scroll_into_view_if_needed()
                try:
                    screenshot = page.screenshot(timeout=3000)
                except:
                    print('screenshot error, pass')
                    break
                ...
                response, messages = inference_with_api(screenshot, current_prompt, messages, model_id=model_id, client=client)
                ...
                try:
                    ...
                    cnt_scroll += 1
                    if (cnt_scroll >= num_scroll) or (cnt_scroll >= len(major_images)):
...
if __name__ == "__main__":
    url = "https://www.yeeyi.com/index.php"  # Replace with your target URL
